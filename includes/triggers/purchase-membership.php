...
class AutomatorWP_Restrict_Content_Pro_Purchase_Membership extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User purchases a membership level', 'automatorwp-restrict-content-pro-integration' ),
            'select_option'     => __( 'User purchases <strong>a membership level</strong>', 'automatorwp-restrict-content-pro-integration' ),
            /* translators: %1$s: Content title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User purchases %1$s %2$s time(s)', 'automatorwp-restrict-content-pro-integration' ), '{membership}', '{times}' ),
            /* translators: %1$s: Content title. */
            'log_label'         => sprintf( __( 'User purchases %1$s', 'automatorwp-restrict-content-pro-integration' ), '{membership}' ),
            ...
            'options'           => array(
                'membership' => automatorwp_utilities_ajax_selector_option( array(
                    'field'             => 'membership',
                    'name'              => __( 'Membership Level:', 'automatorwp-restrict-content-pro-integration' ),
                    'option_none_value' => 'any',
                    'option_none_label' => __( 'any membership level', 'automatorwp-restrict-content-pro-integration' ),
