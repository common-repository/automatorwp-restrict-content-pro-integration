...
class AutomatorWP_Restrict_Content_Pro_Add_Membership extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add membership level to user', 'automatorwp-restrict-content-pro' ),
            'select_option'     => __( 'Add <strong>membership level</strong> to user', 'automatorwp-restrict-content-pro' ),
            /* translators: %1$s: Membership. */
            'edit_label'        => sprintf( __( 'Add %1$s to user', 'automatorwp-restrict-content-pro' ), '{membership}' ),
            /* translators: %1$s: Membership. */
            'log_label'         => sprintf( __( 'Add %1$s to user', 'automatorwp-restrict-content-pro' ), '{membership}' ),
            'options'           => array(
                'membership' => array(
                    'from' => 'membership',
                    'fields' => array(
                        'membership' => array(
                            ...
                            'option_none_label' => __( 'a membership level', 'automatorwp-restrict-content-pro' ),
                            'option_custom'         => true,
                            ...
                            'attributes' => array(
                                ...
                                'data-option-none-label' => __( 'a membership level', 'automatorwp-restrict-content-pro' ),
                        ...
                        'membership_custom' => automatorwp_utilities_custom_field( array(
                            'option_custom_desc'    => __( 'Membership ID', 'automatorwp-restrict-content-pro' ),
                        ) ),
                        'status' => array(
                            'name' => __( 'Status:', 'automatorwp-restrict-content-pro' ),
                            'type' => 'select',
                            'options' => array(
                                'active' => __( 'Active', 'automatorwp-restrict-content-pro' ),
                                'pending' => __( 'Pending', 'automatorwp-restrict-content-pro' ),
                                'expired' => __( 'Expired', 'automatorwp-restrict-content-pro' ),
                                'cancelled' => __( 'Cancelled', 'automatorwp-restrict-content-pro' ),
                            ),
                            'default' => 'active'
                        ),
                        'expiration' => array(
                            'name' => __( 'Expiration Date:', 'automatorwp-restrict-content-pro' ),
                            'desc' => __( 'Enter the membership expiration date in format YYYY-MM-DD. Leave empty for lifetime.', 'automatorwp-restrict-content-pro' ),
                            'type' => 'text',
                            'default' => ''
                        ),
                    )
